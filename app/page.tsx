...
export default function Home() {
  ...
  return (
    <div className="w-full min-h-screen bg-slate-950 text-gray-300 overflow-x-hidden relative">
      {/* Background animado */}
      <Background />

      {/* Gradientes de fundo decorativos */}
      <div className="fixed inset-0 overflow-hidden pointer-events-none opacity-50 md:opacity-100">
        <div className="absolute top-0 left-1/4 w-64 h-64 md:w-96 md:h-96 bg-cyan-500/5 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 right-1/4 w-64 h-64 md:w-96 md:h-96 bg-blue-500/5 rounded-full blur-3xl"></div>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 md:w-96 md:h-96 bg-purple-500/5 rounded-full blur-3xl"></div>
      </div>
